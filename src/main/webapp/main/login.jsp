...
<head>
    ...
    <script type="text/javascript">
        function Code() {
            //点击图片换一张
            document.getElementById("captchaImage").src = "${pageContext.request.contextPath }/code/getCode?" + Math.random();
        }
...
<div class="login">
    <form id="loginForm" action="${pageContext.request.contextPath}/admin/queryOneAdmin" method="post">
