                ...
                success: function (result) {
                    $.each(result, function (index, val) {
                        ...
                        $.ajax({
                            type: "post",
                            async: false,
                            url: "${pageContext.request.contextPath}/menu/secondTitle",
                            data: "pid=" + pid,
                            dataType: "json",
                            success: function (res) {
                                $.each(res, function (index2, value) {
                                    second += "<p style='text-align: center'><a id=\"btn\" href=\"#\" class=\"easyui-linkbutton\" onclick=\"addTabs('" + value.title + "','" + value.iconcls + "','" + value.url + "')\" data-options=\"iconCls:'icon-search'\">" + value.title + "</a></p>";
                                });
                            }
                        });
                        $("#aa").accordion("add", {
